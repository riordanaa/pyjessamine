...
|-------|-------------------------------|----------|
| **Unicode subscript digits** | `x`&#x2081;, `x`&#x2082; | Map all Unicode subscript characters (U+2080 through U+2089) to ASCII digits |
| **Unicode superscripts** | `x`&#x00B2; | Convert to `**n` notation (e.g., `**2`) |
